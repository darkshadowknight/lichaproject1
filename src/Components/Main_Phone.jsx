        ...
        <div className='w-full h-full flex flex-col'>
          <div className='flex flex-col items-center justify-center gap-2'>
            <div className='flex flex-row items-center justify-center h-full w-full rounded-lg appear-sum'>
              ...
              <img className='sm:w-[90%] w-[300px] h-[650px] appear-sum' src={current.image}
                alt={`Slide ${index}`} />
            ...
            <button className='text-3xl bg-gray-500 text-white rounded-lg'>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            ...
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks'>
                <p className='text-white text-5xl blocks'><GrOverview /></p>
                <p className='text-white text-5xl blocks'> Overview</p>
              </div>
              <p className='text-white text-2xl'>Cainta is a first-class urban municipality located in the province of Rizal, Philippines. Known as the "Richest Municipality in the Philippines," Cainta is a thriving residential, commercial, and industrial hub that has seamlessly blended urban progress with cultural heritage. Its strategic location, just east of Metro Manila, makes it a key gateway between the bustling capital and the scenic province of Rizal.</p>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lgitems-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks items-center'>
                ...
                <p className='text-white text-5xl blocks'> Location & Accessibility</p>
              </div>
              <p className='text-white text-2xl blocks'>Cainta has evolved into a highly urbanized area.</p>
              <ul className='text-white text-2xl list-disc pl-7 blocks'>
                <p className='text-white text-2xl blocks'>It is bordered by:</p>
                <li className='blocks'>Pasig City to the west</li>
                <li className='blocks'>Marikina City and Antipolo to the north</li>
                <li className='blocks'>Taytay to the southeast</li>
              </ul>
              <p className='text-white text-2xl blocks'>Its proximity to major roads such as Ortigas Avenue Extension and the C5 Road makes it easily accessible for commuters and businesses alike.</p>
            </div>
          </div>
          {/* Urban Development */}
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks items-center'>
                ...
                <p className='text-white text-5xl blocks'> Urban Development</p>
              </div>
              <p className='text-white text-2xl blocks'>Cainta has evolved into a highly urbanized area.</p>
              <ul className='text-white text-2xl list-disc pl-7 blocks'>
                <p className='text-white text-2xl blocks'>It boasts:</p>
                <li className='blocks'>Modern residential subdivisions</li>
                <li className='blocks'>Commercial centers like Sta. Lucia Mall and Robinsons Metro East</li>
                <li className='blocks'>Business process outsourcing (BPO) offices</li>
                <li className='blocks'>Manufacturing industries and industrial estates</li>
              </ul>
              <p className='text-white text-2xl blocks'>Despite rapid growth, it continues to invest in infrastructure, transport systems, and public services to support its expanding population.</p>
            </div>
          </div>
          {/*  History & Culture */}
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks items-center'>
                ...
                <p className='text-white text-5xl blocks'>  History & Culture</p>
              </div>
              <p className='text-white text-2xl blocks'>Founded on November 30, 1571, Cainta is one of the oldest municipalities in Luzon. It was originally part of the old Province of Tondo and later integrated into the province of Rizal.</p>
              <ul className='text-white text-2xl list-disc blocks pl-7'>
                <p className='text-white text-2xl blocks'>Key Historical Notes:</p>
                <li className='blocks'>Played a significant role during the Spanish colonial era.</li>
                <li className='blocks'>Site of several uprisings during the Philippine Revolution.</li>
                <li className='blocks'>Known for its religious and cultural festivals, especially Senakulo (Passion Play during Holy Week), which draws tourists and cultural enthusiasts.</li>
              </ul>
            </div>
          </div>
          {/*  Local Cuisine */}
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks'>
                ...
                <p className='text-white text-5xl blocks'>   Local Cuisine</p>
              </div>
              <p className='text-white text-2xl blocks'>Cainta is famous for its delicious native delicacies, many of which have roots in Filipino and Spanish culinary</p>
              <ul className='text-white text-2xl list-disc blocks pl-7'>
                <p className='text-white text-2xl blocks'>traditions: </p>
                <li className='blocks'>Played a significant role during the Spanish colonial era.</li>
                <li className='blocks'>Site of several uprisings during the Philippine Revolution.</li>
                <li className='blocks'>Known for its religious and cultural festivals, especially Senakulo (Passion Play during Holy Week), which draws tourists and cultural enthusiasts.</li>
              </ul>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks items-center'>
                ...
                <p className='text-white text-5xl blocks'> Governance</p>
              </div>
              <p className='text-white text-2xl blocks'>Cainta is governed by a municipal mayor, vice mayor, and a Sangguniang Bayan (municipal council). There have been initiatives for Cainta to become a city, and proposals have been made in Congress over the years.</p>
            </div>
          </div>
          {/*  Environment & Tourism */}
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks items-center'>
                ...
                <p className='text-white text-5xl blocks'> Environment & Tourism</p>
              </div>
              <p className='text-white text-2xl blocks'>As of the 2020 census, Cainta has a population of over 376,000, making it one of the most populous municipalities in the country. It continues to grow due to in-migration and urban expansion.</p>
            </div>
          </div>
          {/*  Future Prospects */}
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks'>
              <div className='flex flex-row gap-5 blocks items-center'>
                ...
                <p className='text-white text-5xl blocks'> Future Prospects</p>
              </div>
              <p className='text-white text-2xl blocks'>Cainta is expected to continue growing economically and demographically. With ongoing infrastructure improvements and the potential push for cityhood, it aims to attract more investments while preserving its rich cultural heritage.</p>
            </div>
          </div>
        </div>
      </div>
