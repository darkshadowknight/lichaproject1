...
const Culture_Main_Phone = () => {
  ...
  return (
    <main className='justify-items-center overflow-auto scrollbar-hidden pt-2 flex flex-col gap-20 w-full'>
      <div className='justify-items-center scrollbar-hidden pt-2 flex flex-col gap-20 w-full'>
        ...
        <div className='w-full h-full flex flex-col'>
          <div className='flex flex-col items-center justify-center gap-5'>
            ...
            <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks'>
              {/* 🎭 Festivals and Traditions */}
              <div className='flex flex-col gap-5 blocks p-5'>
                <div className='flex flex-row gap-5 blocks pl-5'>
                  <p className='text-white text-5xl blocks'>{current.title} </p>
                </div>
                <div className='pl-5'>
                  <p className='text-white text-2xl blocks'>{current.description}</p>
                  <p className='text-white text-2xl blocks'>{current.description2}</p>
                  <p className='text-white text-2xl blocks'>{current.description3}</p>
                  <p className='text-white text-2xl blocks'>{current.description4}</p>
                </div>
                <div 
                style={{ display: index === 0 ? 'flex' : 'none' }}
                className='flex flex-row items-center justify-center h-full w-full rounded-lgappear-sum'>
                  <div className='flex items-center h-[50px] rounded-full bg-gray-500 appear-sum'>
                    {/* right arrow */}
                    <BsChevronLeft onClick={prevs} size={30} />
                  </div>

                  <img className='w-[300px] sm:w-[90%] h-[650px] appear-sum' src={currents.Picture}
                    alt={`Slide ${indexs}`} />

                  <div className='flex items-center h-[50px] rounded-full bg-gray-500 appear-sum'>
                    {/* right arrow */}
                    <BsChevronRight onClick={nexts} size={30} />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className='flex flex-col gap-[20px] w-full items-center pb-30'>
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-2 items-center blocks'>
              ...
              <h1 className='text-white text-5xl text-center blocks'>Cainta Culture</h1>
            </div>
            <p className='text-white text-2xl'>Cainta, a municipality in the province of Rizal in the Philippines, has a rich and vibrant culture that blends indigenous, Spanish, and modern Filipino influences.</p>
          </div>
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            {/* 🎭 Festivals and Traditions */}
            <div className='flex flex-col gap-5 blocks p-5'>
              <div className='flex flex-row gap-5 blocks'>
                <p className='text-white text-5xl blocks'>  🎭 Festivals and Traditions</p>
              </div>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lgitems-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks p-5'>
              <div className='flex flex-row gap-5 blocks items-center'>
                <p className='text-white text-5xl blocks'>🍲 Cuisine</p>
              </div>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks p-5'>
              <div className='flex flex-row gap-5 blocks items-center'>
                <p className='text-white text-5xl blocks'> 🎨 Arts and Community</p>
              </div>
              <ul className='text-white text-2xl list-disc blocks pl-7'>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks p-5'>
              <div className='flex flex-row gap-5 blocks items-center'>
                <p className='text-white text-5xl blocks'>  ⛪ Religion</p>
              </div>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks p-5'>
              <div className='flex flex-row gap-5 blocks'>
                <p className='text-white text-5xl blocks'>  👥People and Values</p>
              </div>
              <ul className='text-white text-2xl list-disc blocks pl-7'>
          ...
          <div className='flex flex-col gap-10 bg-blue-950 rounded-lg items-center justify-center blocks pl-5'>
            <div className='flex flex-col gap-5 blocks p-5'>
              ...
              <p className='text-white text-2xl blocks'>
...
export default Culture_Main_Phone