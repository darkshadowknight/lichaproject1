    ...
    <main className='justify-items-center overflow-auto scrollbar-hidden pt-2 flex flex-col gap-20'>
      <div className='flex flex-col gap-[100px] w-full items-center pb-30 '>
        <div class="justify-items-center text-white">
          <p class="text-5xl p-10 text-center">CONTACT US</p>
          <div class="flex flex-col text-white gap-10">
            ...
            <div class="bg-gray-400 h-[100px] w-full flex flex-col items-center justify-center">
              <div class="justify-items-center">
                <p>8696-2617</p>
          ...
          <div class="pt-7 w-screen h-full">
            <iframe
...
export default Contact_Main_Phone